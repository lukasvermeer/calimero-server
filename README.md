...
java -cp "calimero-server-2.6-SNAPSHOT.jar:calimero-core-2.6-SNAPSHOT.jar:calimero-device-2.6-SNAPSHOT.jar" tuwien.auto.calimero.server.Launcher server-config.xml
~~~
